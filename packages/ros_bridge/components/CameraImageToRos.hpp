...
class CameraImageToRos : public ProtoToRosConverter<ColorCameraProto, sensor_msgs::Image> {
 public:
  bool protoToRos(ColorCameraProto::Reader reader, const ros::Time& ros_time,
                  sensor_msgs::Image& ros_message) override;
...
ISAAC_ALICE_REGISTER_CODELET(isaac::ros_bridge::CameraImageToRos);
